...
Pour les passionnés de "live coding" et d'algorave, voici quelques liens intéressants :

- https://github.com/toplap/awesome-livecoding/  (merci à Alex pour l'info)

- https://toplap.org/ (merci à Thomas pour ce lien)
